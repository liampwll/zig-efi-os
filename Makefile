...
bootx64.efi:
	zig build-exe ./src/boot.zig --enable-pic -target x86_64-uefi-msvc --disable-gen-h --override-std-dir "../zig/std" --verbose-link --subsystem efi_application --disable-valgrind --name bootx64
